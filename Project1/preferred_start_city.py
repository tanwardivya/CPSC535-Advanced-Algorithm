...
class Solution:
    ...
    def preferred_starting_city(self,distance:List[int], fuel:List[int], mpg:int)-> int:
        """Returns the preferred starting city.
        ...
        Returns:
            int: Preferred starting city index
        """
        ...
        for current_index in range(length):
            ...
            if capacity < 0:
                ...
                # not be preferred start as the gas isn't enough to reach back to start point.
        ...
        if deficit + capacity >= 0: 
            return start
        # Preferred start city not found
        return -1
